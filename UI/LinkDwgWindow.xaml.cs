...
{
    public partial class LinkDwgWindow : Window
    {
        private readonly WindowResizer _windowResizer;

        public LinkDwgViewModel ViewModel { get; private set; }

        public LinkDwgWindow(IReadOnlyList<string> paths, RevitExternalEventService eventService, bool isDarkMode)
        {
            InitializeComponent();
            ...
            ViewModel                = new LinkDwgViewModel(paths, eventService, isDarkMode);
