...
{
    public partial class CreatePlanSetsWindow : Window
    {
        private readonly WindowResizer _windowResizer;

        public CreatePlanSetsViewModel ViewModel { get; private set; }

        public CreatePlanSetsWindow(RevitExternalEventService eventService, bool isDarkMode)
        {
            InitializeComponent();
            ...
            ViewModel                    = new CreatePlanSetsViewModel(eventService, isDarkMode);
            ViewModel.OnCreateComplete   = () => Close();
